...
import { ClipboardCheck, FileText, BarChart as ChartBar, Upload, UserCircle } from 'lucide-react';
          ...
          <Route
            ...
            element={
              <div className="text-center py-12">
                ...
                <p className="mt-4 text-gray-600">Please select a section from the navigation menu to get started.</p>
              </div>
            }
          />
        </Routes>
